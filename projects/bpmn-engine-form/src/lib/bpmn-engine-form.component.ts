...
@Component({
    selector: 'bpmn-engine-form',
    templateUrl: './bpmn-engine-form.component.html',
    styleUrls: ['./bpmn-engine-form.component.scss']
})
export class BPMNEngineJsonFormComponent implements OnInit {
    ...
    FormGroup: FormGroup;
    types: any = ["checkbox", "color", "date", "email", "file", "hidden", "image", "list", "number", "password", "radio", "select", "tel", "text", "textarea", "textfield", "taglist", "checklist"];
    legends: any = {
        "en-US": {
                        ...
                        if (!field.name || !field.type) {
                            ...
                            if (field.type == "select") {
                                if (field.multiple) {
                                    ...
                                    this.FormGroup.addControl(field.name, new FormControl(field.defaultValue, validators));
                                } else {
                                    if (field.option && field.option.value) {
                                        ...
                                        this.FormGroup.addControl(field.name, new FormControl({ value: field.defaultValue }, validators));
                                    };
                                };
                                ...
                                this.FormGroup.addControl(field.name, new FormControl({ value: field.checked ? true : false, disabled: field.disabled }));
                            } else if (field.type == "radio") {
                                this.FormGroup.addControl(field.name, new FormControl({ value: field.value ? field.value : null, disabled: field.disabled }));
                            } else {
    ...
    ngAfterViewInit() {
        try {
            if (this.form && this.form.format && this.ElementRef && this.ElementRef.nativeElement) {
                if (this.form.format.primary) this.ElementRef.nativeElement.style.setProperty("--bpmn-engine-form-primary", this.form.format.primary);
                if (this.form.format.secondary) this.ElementRef.nativeElement.style.setProperty("--bpmn-engine-form-secondary", this.form.format.secondary);
                if (this.form.format.background) this.ElementRef.nativeElement.style.setProperty("--bpmn-engine-form-background", this.form.format.background);
                if (this.form.format.fill) this.ElementRef.nativeElement.style.setProperty("--bpmn-engine-form-fill", this.form.format.fill);
                if (this.form.format.text) this.ElementRef.nativeElement.style.setProperty("--bpmn-engine-form-text", this.form.format.text);
                if (this.form.format.focus) this.ElementRef.nativeElement.style.setProperty("--bpmn-engine-form-focus", this.form.format.focus);
                if (this.form.format.error) this.ElementRef.nativeElement.style.setProperty("--bpmn-engine-form-error", this.form.format.error);
                if (this.form.format.border) this.ElementRef.nativeElement.style.setProperty("--bpmn-engine-form-border", this.form.format.border);
                if (this.form.format.grey) this.ElementRef.nativeElement.style.setProperty("--bpmn-engine-form-grey", this.form.format.grey);
            };
        } catch (e) {
            console.error("Error", e);
        };
