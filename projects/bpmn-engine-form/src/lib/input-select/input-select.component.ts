    ...
    selectOption(option) {
        try {
            ...
            if (this.field.multiple) {
                let items = this.field.defaultValue ? this.field.defaultValue : this.field.value;
                if (!items) items = [];
                ...
                if (item) {
                    ...
                    console.log(option)
                    this.field.defaultValue ? this.field.defaultValue.push(option) : this.field.value.push(option);
